...
class DashboardController extends Controller
{
    ...
    public function InfoBox()
    {
        ...
        $strQuery = "SELECT SUM(total_sold_price) AS tPrecio, SUM(sold_quantity) AS tVendidos, DATE_FORMAT(selling_date, '%Y-%m-%d') AS fecha FROM sell_details GROUP BY DATE_FORMAT(selling_date, '%Y-%m-%d') ORDER BY DATE_FORMAT(selling_date, '%Y-%m-%d') DESC LIMIT 3";
