...
@section('title','Inventario | Ganacia-Reporte')


@section('page-title','Ganancia Reporte')
				...
				<div class="table-responsive">
					<table class="table table-bordered table-condensed">
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="5" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte ganancia del {{ date('j M Y',strtotime($start_date)) }} al {{ date('j M Y',strtotime($end_date)) }}</p></td>

							</tr>
							<tr>
								<th>Producto</th>
								<th>Cantidad</th>
								<th>Importacion total vendida</th>
