   ...
   <div class="container">
   	 <div class="row">
						...
						<thead>
							...
							<tr style="border: none !important;">
								<td colspan="11" style="border: none !important;"><p style="text-align: center;font-weight: bold;">Reporte de Venta del {{ date('j M Y',strtotime($start_date)) }} al {{ date('j M Y',strtotime($end_date)) }}</p></td>
							...
							<tr>
								...
								<th>Compra Total Importe</th>
								<th>Venta Total Importe</th>
